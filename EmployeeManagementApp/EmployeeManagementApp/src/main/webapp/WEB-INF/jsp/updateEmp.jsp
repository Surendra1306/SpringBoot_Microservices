...
<div class="text-center my-3">
    <p class="text-success font-weight-bold">${succMsg}</p>
    <p class="text-danger font-weight-bold">${errMsg}</p>
</div>
...
<div class = "container">
    <div class = "row">
        <div class ="col-lg-6 col-md-6 col-sm-6 container justify-content-center card">
            ...
            <div class = "card-body">
                <form:form action="${pageContext.request.contextPath}/employees/${editEmployee.id}" modelAttribute="editEmployee" method="POST">
                    ...
                    <div class="box-footer">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="${pageContext.request.contextPath}/employees" class="btn btn-secondary float-right">
                                    Back
                                </a>
                            </div>
                        </div>
